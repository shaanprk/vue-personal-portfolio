...
export default {
  ...
  methods: {
    randomGreeting() {
      const index = Math.floor(Math.random() * this.greetingArr.length)
      this.greeting = this.greetingArr[index]
...
<template>
  <div class="home-page glow">
    <Navbar />
    <!-- text-[#2c3e50] -->
    <div
      class="landing-page flex flex-col justify-center items-center p-8 h-[calc(100vh-20px)] relative"
    >
      <div
